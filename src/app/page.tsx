...
import { ArrowRight, BarChart3, Globe, Mail, MessageSquare, Play, TrendingUp } from "lucide-react"
        ...
        <section className="w-full py-16 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-6 text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-muted-foreground">
                Discover how we transform businesses through innovative digital marketing strategies.
              </p>
            </div>
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              <div className="md:col-span-2">
                ...
                <h3 className="mt-4 text-xl font-semibold">Complete Digital Marketing Course for E-commerce</h3>
                <p className="text-muted-foreground">Learn the fundamentals of digital marketing for e-commerce success</p>
              </div>
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-semibold">Social Media Marketing Masterclass</h3>
                <p className="text-muted-foreground">Advanced strategies for social media success in 2024</p>
              </div>
              <div className="space-y-4">
                <div className="relative aspect-video">
                  <div className="absolute inset-0 bg-primary/20 rounded-2xl blur-2xl"></div>
                ...
                <h3 className="text-lg font-semibold">E-commerce SEO Guide</h3>
                <p className="text-muted-foreground">Essential SEO techniques for online stores</p>
              </div>
              <div className="space-y-4">
                <div className="relative aspect-video">
                  <div className="absolute inset-0 bg-primary/20 rounded-2xl blur-2xl"></div>
                ...
                <h3 className="text-lg font-semibold">Email Marketing Strategies</h3>
                <p className="text-muted-foreground">Convert subscribers into loyal customers</p>
              </div>
              <div className="space-y-4">
                <div className="relative aspect-video">
                  <div className="absolute inset-0 bg-primary/20 rounded-2xl blur-2xl"></div>
                ...
                <h3 className="text-lg font-semibold">Content Marketing Excellence</h3>
                <p className="text-muted-foreground">Create engaging content that drives sales</p>
              </div>
              <div className="md:col-span-2 mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-lg px-8">
